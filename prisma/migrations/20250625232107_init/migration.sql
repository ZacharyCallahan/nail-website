...
-- CreateEnum
CREATE TYPE "ContentType" AS ENUM ('TEXT', 'HTML', 'IMAGE_URL');
...
-- AddForeignKey
ALTER TABLE "AppointmentAddOn" ADD CONSTRAINT "AppointmentAddOn_addOnId_fkey" FOREIGN KEY ("addOnId") REFERENCES "AddOn"("id") ON DELETE CASCADE ON UPDATE CASCADE;
